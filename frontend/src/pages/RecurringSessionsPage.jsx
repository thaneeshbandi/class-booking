  ...
  return (
    <div>
      ...
      <form className="card" onSubmit={handleSubmit}>
        ...
        {validationMessage ? (
          <div className="preview-note is-negative">{validationMessage}</div>
        ) : (
          <div className="preview-note is-positive">
            {candidateCount} session{candidateCount === 1 ? '' : 's'} will be attempted
            {candidateCount > 0 ? ' — some may be skipped if they conflict with an existing session' : ''}.
          </div>
        )}
